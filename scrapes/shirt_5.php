<html>
<head>
	<title>Mike the Frog Shirt, Orange</title>
	...
	<div id="content">
		<div class="section page">
			...
			<div class="wrapper">
				...
				<div class="breadcrumb"><a href="shirts.php">Shirts</a> &gt; Mike the Frog Shirt, Orange</div>

				<div class="shirt-picture">
					<span>
						<img src="img/shirts/shirt-108.jpg" alt="Mike the Frog Shirt, Orange">
					</span>
				</div>

				<div class="shirt-details">

					<h1><span class="price">$25</span> Mike the Frog Shirt, Orange</h1>

					<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="JMFK7P7VEHS44">
						<input type="hidden" name="item_name" value="Mike the Frog Shirt, Orange">
						<table>
						<tr>
							<th>
