	...
	<div id="content">
		<div class="section page">
			...
			<div class="wrapper">
				...
				<div class="breadcrumb"><a href="shirts.php">Shirts</a> &gt; Logo Shirt, Green</div>

				<div class="shirt-picture">
					<span>
						<img src="img/shirts/shirt-104.jpg" alt="Logo Shirt, Green">
					</span>
				</div>

				<div class="shirt-details">

					<h1><span class="price">$18</span> Logo Shirt, Green</h1>

					<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="YKVL5F87E8PCS">
						<input type="hidden" name="item_name" value="Logo Shirt, Green">
						<table>
						<tr>
							<th>
