<html>
<head>
	<title>Mike the Frog Shirt, Black</title>
	...
	<div id="content">
		<div class="section page">
			...
			<div class="wrapper">
				...
				<div class="breadcrumb"><a href="shirts.php">Shirts</a> &gt; Mike the Frog Shirt, Black</div>

				<div class="shirt-picture">
					<span>
						<img src="img/shirts/shirt-102.jpg" alt="Mike the Frog Shirt, Black">
					</span>
				</div>

				<div class="shirt-details">

					<h1><span class="price">$20</span> Mike the Frog Shirt, Black</h1>

					<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="SXKPTHN2EES3J">
						<input type="hidden" name="item_name" value="Mike the Frog Shirt, Black">
						<table>
						<tr>
							<th>
