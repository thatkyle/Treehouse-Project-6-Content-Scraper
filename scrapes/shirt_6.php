<html>
<head>
	<title>Mike the Frog Shirt, Yellow</title>
	...
	<div id="content">
		<div class="section page">
			...
			<div class="wrapper">
				...
				<div class="breadcrumb"><a href="shirts.php">Shirts</a> &gt; Mike the Frog Shirt, Yellow</div>

				<div class="shirt-picture">
					<span>
						<img src="img/shirts/shirt-105.jpg" alt="Mike the Frog Shirt, Yellow">
					</span>
				</div>

				<div class="shirt-details">

					<h1><span class="price">$25</span> Mike the Frog Shirt, Yellow</h1>

					<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="4CLP2SCVYM288">
						<input type="hidden" name="item_name" value="Mike the Frog Shirt, Yellow">
						<table>
						<tr>
							<th>
