<html>
<head>
	<title>Mike the Frog Shirt, Blue</title>
	...
	<div id="content">
		<div class="section page">
			...
			<div class="wrapper">
				...
				<div class="breadcrumb"><a href="shirts.php">Shirts</a> &gt; Mike the Frog Shirt, Blue</div>
				...
				<div class="shirt-details">
					...
					<h1><span class="price">$20</span> Mike the Frog Shirt, Blue</h1>

					<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick">
						<input type="hidden" name="hosted_button_id" value="7T8LK5WXT5Q9J">
